                    ...
                    <div class="ibox">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                <a href="{{ route('company.projects.create') }}" class="btn btn-primary btn-xs">Create new project</a>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        <tr v-for="project in filteredProjects">
                                            ...
                                            <td class="project-title">
                                                <a href="/company/projects/@{{ project.id }}">@{{ project.title }}</a>
                                                <br/>
                                            ...
                                            <td class="project-actions">
                                                ...
                                                <a href="/company/projects/@{{ project.id }}/edit" class="btn btn-white btn-sm"><i class="fa fa-pencil"></i> Edit</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
