                    ...
                    <div class="ibox">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                <a href="#" v-if="spark.usesStripe && profile.stripe_id" @click="addDiscount(profile)">
                                    <i class="fa fa-gift"></i>
                                </a>
                                <a href="#" @click="impersonate(profile)" :disabled="user.id === profile.id">
                                    <i class="fa fa-user-secret"></i>
                                </a>
                                <a class="close-link">
                                    <i class="fa fa-times" @click="showSearch"></i>
                                </a>
                            </div>
