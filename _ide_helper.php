...
namespace {
    ...
    class Youtube extends \Alaouy\Youtube\Facades\Youtube{
        ...
        public static function searchChannelVideos($q, $channelId, $maxResults = 10, $order = null, $part = array()){
            return \Alaouy\Youtube\Youtube::searchChannelVideos($q, $channelId, $maxResults, $order, $part);
        }
        ...
        public static function getActivitiesByChannelId($channelId, $part = array(), $maxResults = 5){
            return \Alaouy\Youtube\Youtube::getActivitiesByChannelId($channelId, $part, $maxResults);
        }
